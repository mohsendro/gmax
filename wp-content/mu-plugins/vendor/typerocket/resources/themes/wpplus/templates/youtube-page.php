...
<?php /* Template Name: قالب صفحه تبلیغ در یوتیوب */ ?>
            ...
            <div class="row">
                <div class="col-12 col-xl-6 content-column column">
                    ...
                    <p class="desc">
                        ...
                        در پربازدیدترین پلتفرم ویدئویی جهان و درکنار موفق ترین شرکت ها، با تکیه بر اعتبار یوتیوب تبلیغ شما باعث شگفتی بیننده می شود.
                    </p>
                    <ul class="details">
