...
<?php /* Template Name: قالب صفحه تبلیغ در گوگل */ ?>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-xl-6 content-column column">
                    ...
                    <p class="desc">
                        تبلیغ در گوگل بهترین راه حل برای معرفی محصول و خدمات شما به مشتریان صد در صدی است. شما با این نوع از تبلیغات، محصول خود را در بالاترین رتبه های گوگل، به کسانی که برای آن جستجو می کنند نشان خواهید داد
                    </p>
                    <ul class="details">
                        ...
                        <li>امکان مدیریت زمان پاسخگویی و تماس مشتریان</li>
                    </ul>
                ...
                <div class="col-12 col-xl-6 img-column column">
                    <img src="<?php echo TYPEROCKET_DIR_URL; ?>resources/assets/img/googleads.png" alt="google-ads">
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="row">
            <div class="col-12 col-xl-3 column">
                ...
                <div class="feacher" data-aos="fade-in" data-aos-duration="500" data-aos-delay="300" data-aos-easing="ease-in-sine">
                    <div class="icon">
                        <svg width="75px" height="auto" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                            ...
                            <g id="Layer_1">
                                <path d="M48.779,9.635L42.77,7.23l-2.404-6.01L37.22,4.365C33.521,2.17,29.318,1,25,1C11.767,1,1,11.767,1,25s10.767,24,24,24
                                    ...
                                    C37.7,18.303,39,21.499,39,25c0,7.72-6.28,14-14,14s-14-6.28-14-14s6.28-14,14-14c3.5,0,6.697,1.3,9.154,3.432L29.898,18.688z"/>
                            </g>
                            <g>
                            </g>
                        </svg>
            ...
            <div class="col-12 col-xl-3 column">
                ...
                <div class="feacher" data-aos="fade-in" data-aos-duration="500" data-aos-delay="0" data-aos-easing="ease-in-sine">
                    <div class="icon">
                        <svg width="75px" height="auto" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
            ...
            <div class="col-12 col-xl-3 column">
                ...
                <div class="feacher" data-aos="fade-in" data-aos-duration="500" data-aos-delay="600" data-aos-easing="ease-in-sine">
                    <div class="icon">
                        <svg width="75px" height="auto" id="Слой_1" data-name="Слой 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100">
                            <path d="M88,77.5H83.5V16A1.5,1.5,0,0,0,82,14.5H68A1.5,1.5,0,0,0,66.5,16V77.5h-8V39A1.5,1.5,0,0,0,57,37.5H43A1.5,1.5,0,0,0,41.5,39V77.5h-8V61A1.5,1.5,0,0,0,32,59.5H18A1.5,1.5,0,0,0,16.5,61V77.5H12a1.5,1.5,0,0,0,0,3H88a1.5,1.5,0,0,0,0-3Zm-18.5-60h11v60h-11Zm-25,23h11v37h-11Zm-25,22h11v15h-11Z"/>
                            <path d="M13,49.5a1.5,1.5,0,0,0,1.06-.44L55.5,7.62V14a1.5,1.5,0,0,0,3,0V4a1.49,1.49,0,0,0-.11-.55v0a1.5,1.5,0,0,0-.82-.82h0A1.49,1.49,0,0,0,57,2.5H47a1.5,1.5,0,0,0,0,3h6.38L11.94,46.94A1.5,1.5,0,0,0,13,49.5Z"/>
                        </svg>
                    </div>
